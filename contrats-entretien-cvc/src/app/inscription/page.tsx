    ...
    <main className="min-h-dvh flex items-center justify-center px-5 py-10">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted">Créer le compte de votre entreprise</p>
        </div>
        ...
        <div className="rounded-card border border-line bg-card p-6 shadow-sm">
          ...
          <p className="text-muted mb-6 text-sm">
            Ce compte sera le compte <strong>Dirigeant</strong>. Vous pourrez
            ensuite créer des comptes Administratif et Technicien depuis la
            page Équipe.
          </p>
          ...
          <form action={formAction} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                required
                className={champ}
                placeholder="Chauffage Dupont SARL"
              />
            </div>
            <div>
              ...
              <input id="nom" name="nom" required className={champ} placeholder="Jean Dupont" />
            </div>
            <div>
